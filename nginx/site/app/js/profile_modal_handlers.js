...
for (let i = 0; i < profileButtonRegistry.length; i++) {

    if (profileButtonRegistry[i] === null) continue;
    profileButtonRegistry[i].addEventListener("click", openModalForm);
}
